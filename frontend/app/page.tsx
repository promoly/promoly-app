  ...
  const features = [
    {
      ...
      description: "Chat with your personal AI marketing expert for instant campaign optimization and strategic advice.",
    },
    {
      icon: Zap,
      title: "Lightning Fast Setup",
      description: "Create and launch campaigns in minutes, not hours. Our AI handles the complex setup automatically.",
    },
    {
      icon: BarChart3,
      title: "Real-time Analytics",
      description: "Monitor performance with live dashboards and get actionable insights powered by machine learning.",
    },
    {
      icon: Shield,
      title: "Enterprise Security",
      description: "Bank-level security with SOC 2 compliance. Your data and campaigns are always protected.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              ...
              <span className="text-purple-300 text-sm font-medium">AI Generated Campaigns</span>
            </motion.div>
            ...
            >
              The AI-powered ads management platform that's revolutionizing how media buyers and agencies create, optimize, and scale their campaigns. Like Bolt.new, but for advertising.
            </motion.p>
                  ...
                  <div className="bg-slate-800/50 rounded-xl p-6 mb-6">
                    ...
                    <div className="flex items-center bg-slate-700/50 rounded-lg p-3">
                      <input
                        ...
                        readOnly
                      />
                      <Button size="sm" className="bg-purple-600 hover:bg-purple-700 ml-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Powered by cutting-edge AI, Promoly transforms how you create, manage, and optimize advertising campaigns across all platforms.
            </p>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-gray-400 mb-8">Trusted by leading agencies and media buyers</p>
      ...
      <section className="py-24 bg-gradient-to-r from-purple-900/50 to-pink-900/50">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of media buyers who are already using Promoly to create better campaigns faster than ever before.
          </p>
