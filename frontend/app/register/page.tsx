    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center bg-slate-900 p-8">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400">Join thousands of marketers revolutionizing their campaigns</p>
          </div>
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-white/80 text-sm">Budget optimized automatically</p>
        </motion.div>
        ...
        >
          <h3 className="text-white font-semibold mb-4">Join 10,000+ marketers</h3>
